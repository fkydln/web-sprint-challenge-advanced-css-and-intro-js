...
Use an array method to fix this issue and console.log() to check your work. */
  ...
  artists[8].name = "Vincent Van Gogh"; //Changing the name by using array methods.
  console.log(artists[8]); //Checks my work
...
and returns an array with names of artists who were born in 
and died in 20th century (1900-2000) example born in 1901 
